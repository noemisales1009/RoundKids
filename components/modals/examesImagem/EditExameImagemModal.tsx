...
export const EditExameImagemModal: React.FC<{
    exame: ExameImagemRow;
    onClose: () => void;
    onSuccess: () => void;
}> = ({ exame: exameData, onClose, onSuccess }) => {
    const { showNotification } = useContext(NotificationContext)!;
    const { user } = useContext(UserContext)!;

    const [categoria, setCategoria] = useState(exameData.categoria);
