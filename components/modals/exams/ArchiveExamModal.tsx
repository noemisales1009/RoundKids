...
export const ArchiveExamModal: React.FC<ArchiveExamModalProps> = ({ exam, patientId, onClose, onSuccess }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (error) {
                ...
                showNotification({ message: 'Erro ao arquivar exame', type: 'error' });
                return;
            }
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                            Exemplo: Exame cancelado, resultado já obtido, etc.
                        </p>
                    </div>
