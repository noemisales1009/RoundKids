        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-30 p-2 sm:p-4">
            <div className="bg-white dark:bg-slate-900 p-4 sm:p-6 rounded-lg shadow-xl w-full max-w-sm max-h-[90vh] overflow-y-auto">
                ...
                <textarea
                    ...
                    className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 transition text-sm sm:text-base text-slate-800 dark:text-slate-200 min-h-24"
                />
                <div className="flex flex-col sm:flex-row gap-2 mt-4">
                    ...
                    <button onClick={() => onSave(alert, justification)} className="flex-1 bg-primary-500 hover:bg-primary-600 text-white font-bold py-2 px-3 sm:px-4 rounded-lg transition text-sm sm:text-base">Salvar</button>
                </div>
            </div>
        </div>
    );
