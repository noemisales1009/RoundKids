...
const escalasConfig = {
  finnegan: {
    ...
    colorKey: 'pink',
    itens: [
      { id: 'choro', label: '1. Choro', maxScore: 5, ranges: ['Normal', 'Mais frequente', 'Difícil consolo', 'Agudo e persistente'] },
      ...
      { id: 'convulsoes', label: '7. Convulsões', maxScore: 5, ranges: ['Ausente', 'Leve', 'Moderada', 'Grave', 'Convulsão'] },
