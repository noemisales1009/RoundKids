      ...
      {tela === 'intro' && (
        <div className="space-y-4 animate-in fade-in duration-500">
          <div className="p-8 rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">{VNICNAF_CONFIG.titulo}</h2>
              <p className="text-sm text-slate-500 dark:text-slate-400">{VNICNAF_CONFIG.nomeCompleto}</p>
            </div>

            <div className="p-4 rounded-lg bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 text-[12px] text-slate-500 dark:text-slate-400 space-y-3">
