...
const SECTION_SISTEMAS: Record<string, string[]> = {
  ...
  gastrointestinal: ['Avaliação gastrointestinal', 'Avaliação hepatológica'],
...
const ESPECIALISTA_TO_SISTEMAS: Record<string, string[]> = {
  ...
  'Hepatologista':        ['Avaliação hepatológica'],
        ...
        <div className="flex gap-2">
          <button
            onClick={() => {
              ...
              previewCtx.rebuildRef.current = () => buildTextContent().replace(/@@DEVICES_TABLE@@/g, buildDevicesText());
