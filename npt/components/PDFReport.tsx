...
const ReportRow: React.FC<{ label: string; value: string | number; unit?: string }> = ({ label, value, unit }) => (
    <div className="flex justify-between items-center py-0 border-b border-slate-200 text-xs">
        <p className="text-xs text-slate-600">{label}</p>
        <p className="text-xs font-semibold text-slate-900">{value} {unit}</p>
    </div>
);
...
export const PDFReport: React.FC<PDFReportProps> = ({ reportData, nptStages = 2 }) => {
  ...
  const commonFooter = (
    <footer className="text-center text-slate-500 text-xs mt-auto pt-4 border-t border-slate-200">
  ...
  return (
    <div id="pdf-report" className="bg-white font-sans text-slate-800">
        ...
        <div className="p-6" style={{ width: '210mm', height: '297mm', boxSizing: 'border-box', display: 'flex', flexDirection: 'column' }}>
            <header className="text-center mb-4 border-b-2 border-slate-800 pb-2">
                {hospitalHeader}
                <h1 className="text-2xl font-bold text-slate-900">Relatório de Nutrição Parenteral</h1>
                <p className="text-xs text-slate-500 mt-1">Gerado em: {generatedDate}</p>
            </header>

            <section className="mb-3">
                <h2 className="text-lg font-bold border-b border-slate-300 pb-1 mb-2">Dados do Paciente</h2>
            ...
            {precipitationWarnings.length > 0 && (
                <section className="mb-3">
                    <h2 className="text-lg font-bold border-b border-slate-300 pb-1 mb-2 text-amber-700">Alertas de Segurança</h2>
            ...
            <main className="grow">
                <h2 className="text-lg font-bold border-b border-slate-300 pb-1 mb-3">Detalhamento dos Macronutrientes</h2>
        ...
        <div className="p-6" style={{ width: '210mm', minHeight: '297mm', boxSizing: 'border-box', display: 'flex', flexDirection: 'column' }}>
            <header className="text-center mb-4 border-b-2 border-slate-800 pb-2">
                {hospitalHeader}
                <h1 className="text-2xl font-bold text-slate-900">Relatório de Nutrição Parenteral</h1>
                <p className="text-xs text-slate-500 mt-1">Detalhamento de Componentes (Continuação)</p>
            </header>
            ...
            <main className="grow grid grid-cols-2 gap-4 text-xs">
                {/* Glicose */}
                 <div className="space-y-2">
                    <div>
                        <h3 className="text-base font-bold text-slate-800 mb-1">Glicose</h3>
                        <div className="space-y-0 bg-slate-50 p-2 rounded-md border border-slate-200">
                            ...
                            {volumeToComplete > 0 && (
                              <div className="pt-1.5 mt-1.5 border-t border-slate-200">
                                <h4 className="font-semibold text-sm text-slate-700 pb-1">Preparo da Solução Final</h4>
                ...
                <div className="space-y-3">
                    <h3 className="text-lg font-bold text-slate-800 mb-2">Eletrólitos, Oligoelementos & Vitaminas</h3>
                     <div className="bg-slate-50 p-3 rounded-md border border-slate-200 space-y-2">
                        <div>
                            <h4 className="font-semibold text-sm text-slate-700 pb-1">Fósforo</h4>
                        ...
                        <div className="pt-1.5 border-t border-slate-200">
                            <h4 className="font-semibold text-sm text-slate-700 pb-1">Sódio</h4>
                        ...
                        <div className="pt-1.5 border-t border-slate-200">
                           <h4 className="font-semibold text-sm text-slate-700 pb-1">Potássio</h4>
                         ...
                         <div className="pt-1.5 border-t border-slate-200">
                            <h4 className="font-semibold text-sm text-slate-700 pb-1">Cálcio & Magnésio</h4>
                         ...
                         <div className="pt-1.5 border-t border-slate-200">
                            <h4 className="font-semibold text-sm text-slate-700 pb-1">Oligoelementos</h4>
                             <ReportRow label="Volume" value={oligoelementosVolume.toFixed(1)} unit="mL" />
                        </div>
                        <div className="pt-1.5 border-t border-slate-200">
                            <h4 className="font-semibold text-sm text-slate-700 pb-1">Vitaminas (Frutovitam)</h4>
        ...
        <div className="p-8" style={{ width: '210mm', minHeight: '297mm', boxSizing: 'border-box', display: 'flex', flexDirection: 'column' }}>
            <header className="text-center mb-8 border-b-2 border-slate-800 pb-4">
                {hospitalHeader}
                <h1 className="text-3xl font-bold text-slate-900">Análise de Cálculos</h1>
                <p className="text-sm text-slate-500 mt-1">Distribuição Calórica, Osmolaridade & Fontes de Fósforo</p>
            </header>
            ...
            <main className="grow">
                 ...
                 <section className="mb-6">
                    <h2 className="text-xl font-bold border-b border-slate-300 pb-2 mb-3">Detalhamento da Osmolaridade</h2>
                    <div className="space-y-1 text-sm bg-slate-50 p-3 rounded-md border border-slate-200">
                ...
                <div className="grid grid-cols-2 gap-8 pt-4">
                    ...
                    <div>
                        <h2 className="text-xl font-bold border-b border-slate-300 pb-2 mb-3">Cenário: Glicerofosfato de Sódio</h2>
                        <div className="bg-slate-50 p-4 rounded-md border border-slate-200 space-y-4 text-sm">
                            <div>
                                <h4 className="font-semibold text-base text-slate-700 pb-1">Fósforo</h4>
                            ...
                            <div className="pt-3 border-t border-slate-200">
                                <h4 className="font-semibold text-base text-slate-700 pb-1">Sódio</h4>
                             ...
                             <div className="pt-3 border-t border-slate-200 opacity-50">
                                <h4 className="font-semibold text-base text-slate-700 pb-1">Potássio (Não afetado)</h4>
                    ...
                    <div>
                        <h2 className="text-xl font-bold border-b border-slate-300 pb-2 mb-3">Cenário: Fosfato Ácido de Potássio</h2>
                        <div className="bg-slate-50 p-4 rounded-md border border-slate-200 space-y-4 text-sm">
                            <div>
                                <h4 className="font-semibold text-base text-slate-700 pb-1">Fósforo</h4>
                            ...
                            <div className="pt-3 border-t border-slate-200 opacity-50">
                                <h4 className="font-semibold text-base text-slate-700 pb-1">Sódio (Não afetado)</h4>
                            ...
                            <div className="pt-3 border-t border-slate-200">
                                <h4 className="font-semibold text-base text-slate-700 pb-1">Potássio</h4>
